...
[逐世界结果CSV](results/campaign-022.csv)。[二十二轮完整验收草稿](https://github.com/nikolasandwich/bitgenesis/releases/tag/untagged-ad8e66198d19fbc2a834)已包含本轮；新目录复算三份报告一致，独立安装通过191项测试与千步演示核验。详见[验收入口](REVIEW.zh-CN.md)。旧归档保留原范围。
