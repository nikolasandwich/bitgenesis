"""Campaign 014: movement-cost grid and reciprocal initial frequencies."""
...
def main():
    ...
    metadata = {"protocol": "campaign-014-frequency-cost-1", "rules_version": "v0-darwin-1",
                "steps": 3000, "seeds": list(range(1200, 1210)), "initial_b_counts": [8, 72],
                "movement_costs": [1, 2, 3, 4], "baseline_config": asdict(base),
            ...
            for treatment, b_trait in (("competition", 1000), ("neutral", 250)):
                ...
                for seed in metadata["seeds"]:
                    ...
                    for tick in range(metadata["steps"] + 1):
                        ...
                        history.append({**world.snapshot(), "a": n-count_b, "b": count_b,
