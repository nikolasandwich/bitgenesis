...
def main():
    ...
    datasets=("campaign-017","feeding-replay-017","feeding-replay-017-schema2",
              "feeding-replay-017-schema3","action-replay-017")
    ...
    manifest=dict(format="bitgenesis-review-1",git_commit=git("rev-parse","HEAD"),
        scope="Observation supplement: tracked source, campaign-017 original records and four successive observer replays. Earlier campaigns' raw data and visual review pages are not included.",
