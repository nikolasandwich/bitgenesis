...
from verify_v3_pilot001 import verify
...
def main():
    ...
    for checked in gate['checks']:
        ...
        for identifier,o in organisms.items():
            ...
            individual_rows.append(dict(id=identifier,parent=o['parent'],allocation_a=o['genome']['allocation_a'],
    ...
    with (root/'diagnosis.json').open('x',encoding='utf-8') as stream:
        ...
        stream.write('\n')
    for row in results:
        print(row['directory'],row['lifetime_totals'],flush=True)
