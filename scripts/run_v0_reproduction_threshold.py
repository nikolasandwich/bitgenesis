"""Factorial allocation and reproduction-threshold assay under unchanged V0 rules."""
...
def main():
    ...
    protocol = {"protocol": "campaign-010-reproduction-threshold-1", "rules_version": "v0-darwin-1",
                "steps": 10000, "seeds": list(range(900, 910)), "treatments": [("food-40", 5, 24, 40), ("stored-40", 0, 88, 40), ("food-160", 5, 24, 160), ("stored-160", 0, 88, 160)],
